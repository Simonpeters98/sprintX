...
function init(){
    ...
    const geometry = new THREE.SphereGeometry(2, 32, 32); //lengte, breedte, hoogte van cube
    const material = new THREE.MeshBasicMaterial({ color: 0xFCFF00 }); //Kleur van de mesh
